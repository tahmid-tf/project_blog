...
<header class="header">
        ...
        <div class="nav__container container">
            <ul class="nav__list">
                ...
                <li class="nav__item nav__item--active">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('img/analytical_Toolkit.png') }}" alt="" class="logo_shape">
                    </a>
                </li>
                ...
                <li class="nav__item nav__item--active">
                    <a href="{{ route('blog.about') }}">About Me</a>
                </li>
    ...
    <br><br>
    <div class="col-md-12 header__logo logo_hidden_show">
        <div class="logo">
            <h1><a class="logo__link" href="#">
                    <img src="{{ asset('img/analytical_Toolkit.png') }}" alt="" class="img-fluid logo_width">
                </a></h1>
...
<footer class="footer">
    <div class="container footer__top">
        ...
        <div class="col-sm-4 col-md-4">
            ...
            @foreach(\App\Http\Controllers\FrontController::footer_blogs() as $blog)
...
<div class="search-popup">
    ...
    <div class="search-popup__container container">
        <form action="{{ route('blog.search') }}" method="post">
            ...
            <input type="text" size="32" placeholder="Search" name="search"/>
        </form>
    </div>
